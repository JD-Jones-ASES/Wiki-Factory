...
> [[_overview|Home]] > [[Precalculus_Overview|Pre-Calculus]] > IntroPolar
...
- **Algebra & Trigonometry (Stitz-Zeager, Corrected 3rd)** --- Chapter 8 (Applications of Trigonometry), Section 8.2: IntroPolar

## Key Properties

- **(untitled)** --- Conversion Between Rectangular and Polar Coordinates: Suppose P is represented in rectangular coordinates as (x,y) and in polar coordinates as (r,). Then itemize x = r () and y = r() x^2+y^2 = r^2 and...
...
<div class="problem-vault-widget" data-topic-slug="intropolar"></div>
