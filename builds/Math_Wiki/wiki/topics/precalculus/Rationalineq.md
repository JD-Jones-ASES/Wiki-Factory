...
> [[_overview|Home]] > [[Precalculus_Overview|Pre-Calculus]] > RationalIneq
...
- **Algebra & Trigonometry (Stitz-Zeager, Corrected 3rd)** --- Chapter 4 (Rational Functions), Section 4.3: RationalIneq

## Definitions

- **(untitled)** --- Suppose x, y and z are variable quantities. We say itemize y varies directly with (or is directly proportional to) x if there is a constant k such that y=kx. y varies inversely with (or is inversely p...
...
<div class="problem-vault-widget" data-topic-slug="rationalineq"></div>
