...
> [[_overview|Home]] > [[Precalculus_Overview|Pre-Calculus]] > FunctionArithmetic
...
- **Algebra & Trigonometry (Stitz-Zeager, Corrected 3rd)** --- Chapter 1 (Relations and Functions), Section 1.2: FunctionArithmetic

## Definitions

- **(untitled)** --- Given a function f, the difference quotient of f is the expression \[ f(x+h) - f(x){h} \]
...
<div class="problem-vault-widget" data-topic-slug="functionarithmetic"></div>
