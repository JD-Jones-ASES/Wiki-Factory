...
> [[_overview|Home]] > [[Precalculus_Overview|Pre-Calculus]] > GraphsofEquations
...
- **Algebra & Trigonometry (Stitz-Zeager, Corrected 3rd)** --- Chapter 1 (Relations and Functions), Section 1.4: GraphsofEquations

## Definitions

- **(untitled)** --- Suppose the graph of an equation is given. itemize A point at which a graph meets the x-axis is called an x-intercept of the graph. A point at which a graph meets the y-axis is called an y-intercept o...
...
<div class="problem-vault-widget" data-topic-slug="graphsofequations"></div>
