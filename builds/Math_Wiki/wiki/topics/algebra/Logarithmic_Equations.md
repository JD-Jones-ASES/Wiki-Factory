...
- **Algebra II** --- Chapter 7 (Exponential and Logarithmic Functions), Section 7.5: Logarithmic Equations

## Key Properties

- **(untitled)** --- {Strategy for Solving Logarithmic Equations}{ch07:log-eq-strategy} enumerate Isolate the logarithm (or combine logs on one or both sides). Convert to exponential form: _b M = c M = b^c. Solve the resu...
